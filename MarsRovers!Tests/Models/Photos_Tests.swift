...
class Photos_Tests: XCTestCase {
    ...
    func testPhotosFromJson() {
        ...
        // Test that a Photos model will be created with JSONDecoder using the example json string.
        ...
        guard let data = json.data(using: .utf8),
            let decodedJson = try? JSONDecoder().decode(Photos.self, from: data),
            let firstPhoto = decodedJson.photos.first
        ...
        let expectedPhoto =
                Photo(id: 301536,
                      ...
                      rover: Rover(id: 7,
                                   ...
                                   totalPhotos:124550,
                                   cameras:[
                                    CameraElement(name:"FHAZ",fullName:"Front Hazard Avoidance Camera"),
                                    CameraElement(name:"NAVCAM",fullName:"Navigation Camera"),
                                    CameraElement(name:"PANCAM",fullName:"Panoramic Camera"),
                                    CameraElement(name:"MINITES",fullName:"Miniature Thermal Emission Spectrometer (Mini-TES)"),
                                    CameraElement(name:"ENTRY",fullName:"Entry, Descent, and Landing Camera"),
                                    CameraElement(name:"RHAZ",fullName:"Rear Hazard Avoidance Camera")
                                    ]))
